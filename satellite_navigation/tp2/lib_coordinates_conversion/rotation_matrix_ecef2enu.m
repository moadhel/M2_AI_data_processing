function R_ecef2enu = rotation_matrix_ecef2enu(ref_llh, unit)

% Rotation matrix
% between WGS84 ECEF frame and cartesian ENU frame (East North Up)
%
% Syntax :
% R_ecef2enu = rotation_matrix_ecef2enu(ref_llh);
% R_ecef2enu = rotation_matrix_ecef2enu(ref_llh, unit);
%
%
% Input :
