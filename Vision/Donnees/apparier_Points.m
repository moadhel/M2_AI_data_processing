...
covariance=zeros(nbptintI1,nbptintI2);
for i=1:nbptintI1*nbptintI2
    covariance(i1(i),i2(i))=(vois1(i1(i),:)-moy1(i1(i)))*(vois2(i2(i),:)-moy2(i2(i)))'/NbPix;
end
